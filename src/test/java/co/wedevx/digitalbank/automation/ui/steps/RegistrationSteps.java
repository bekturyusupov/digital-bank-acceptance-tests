...
public class RegistrationSteps {
    ...
    public void theFollowingUserInfoShouldBeSavedInTheDb(List<Map<String, String>> expectedUserProfileInfoInDBList) {
        ...
        assertEquals(1, actualUserProfileInfoList.size(), "registration generated unexpected number of users profile");
        ...
        assertEquals(expectedUserInfoMap.get("email"), String.valueOf(actualUserInfoMap.get("username")), "username mismatch upon registration");
