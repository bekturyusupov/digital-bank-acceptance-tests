...
public class NewCheckingAttributes {
    private String checkingAccountType;
    private String accountOwnership;
    private String accountName;
    private double initialDepositAmount;

    public NewCheckingAttributes(String checkingAccountType, String accountOwnership, String accountName, double initialDepositAmount) {
