...
public class DataTableTransformer {
    ...
    @DataTableType
    public TransactionsTable transactionsTableEntry(Map<String, String> entry){
        ...
        return new TransactionsTable(date, category, description, amount, balance);
    }

    @DataTableType
    public NewCheckingAttributes newCheckingAttributes(Map<String, String> entry){
        ...
        return new NewCheckingAttributes(checkingAccountType, accountOwnership, accountName, initialDepositAmount);
    }
}
